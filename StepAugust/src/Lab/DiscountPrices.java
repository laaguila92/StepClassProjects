...
import java.math.*;
	...
	public class DiscountPrices {
		...
		Scanner input =  new Scanner(System.in);
			...
			{
				System.out.println("Your original total was "+ original_price+ " cents. After your discount, your new total is: " + discount_price+" cents. Or if you prefer : $" + discount_dollar);//displays the total amount to the user after the discount was applied
			}
				else
				System.out.println("Your final total is : " + original_price+" cents. Or if you prefer : $" + original_dollar);//displays the original price since the discount was not applicable
